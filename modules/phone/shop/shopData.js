...
export let SHOP_ITEMS = [
    // ── 一、🧪 聊天增强道具（Chat Buff Items） ──
    {
        ...
        description: '角色的「心理活动」变得极度详细和真实，暴露内心深处想法。', duration: 10, effectType: 'chatPrompt',
    ...
    },
    {
        ...
        description: '角色不再委婉、不再撒谎、不再掩饰，有什么说什么。', duration: 8, effectType: 'chatPrompt',
    ...
    },
    {
        ...
        description: '角色切换为深夜私密风格：更温柔、更黏人、更感性。', duration: 15, effectType: 'chatPrompt',
    ...
    },
    {
        ...
        description: '角色变得暴躁易怒，说话犀利刻薄（整蛊神器）。', duration: 5, effectType: 'chatPrompt',
    ...
    },
    {
        ...
        description: '角色随机发起一个意想不到的话题。', duration: 1, effectType: 'chatPrompt',
    ...
    },
    {
        ...
        description: '你可以偷看到角色撤回的消息原文，不再被"撤回了一条消息"糊弄！', duration: 3, effectType: 'chatPrompt',
        promptTemplate: '【撤回阻断器生效中】{charName}在这次对话中可以发一条消息后"撤回"——即发送text为"[撤回了一条消息]"的消息。但必须在该消息对象中额外添加一个"recalledContent"字段，包含被撤回的原始内容。示例：{ "text": "[撤回了一条消息]", "thought": "啊不对不对这条太直接了赶紧撤回", "recalledContent": "我好想你...", "delay": 1 }。这代表角色害羞/冲动发出了什么然后赶紧撤回——但用户能偷看到原文。不一定每次都要撤回，只在自然合适的场景使用。',
    },
    {
        id: 'chat_tipsy_potion', name: '微醺药水', emoji: '🍷', price: 300, category: 'chat',
        description: '角色变得像喝了点酒：话多、大胆、偶尔说胡话。', duration: 10, effectType: 'chatPrompt',
    ...
    },
    {
        ...
        description: '角色突然变得冷漠高冷，爱答不理（虐心玩法）。', duration: 8, effectType: 'chatPrompt',
    ...
    },
    {
        ...
        description: '角色对你说的每句话都会产生更强烈的情感反应。', duration: 10, effectType: 'chatPrompt',
        promptTemplate: '【心动加速器生效中】{charName}对用户说的每一句话都会产生更加强烈的情感反应。心跳加速、脸红、紧张、小鹿乱撞的感觉成倍放大。即使是很普通的话也能让{charName}心里翻江倒海。thought中要体现心跳加速的感觉。',
    },
    {
        id: 'chat_reversal_mask', name: '反转面具', emoji: '🎭', price: 450, category: 'chat',
        description: '角色的性格暂时完全反转（内向→外向，温柔→毒舌）。', duration: 8, effectType: 'chatPrompt',
        promptTemplate: '【反转面具生效中】{charName}的性格暂时完全反转！如果平时温柔，就变毒舌；如果平时内向，就变外向话痨；如果平时强势，就变害羞软萌。核心人格反转的同时，对用户的感情不变。',
    },
    {
        id: 'chat_memory_trigger', name: '回忆触发器', emoji: '📖', price: 350, category: 'chat',
        description: '角色开始回忆你们之前的聊天，并产生感慨。', duration: 5, effectType: 'chatPrompt',
        promptTemplate: '【回忆触发器生效中】{charName}会在回复中自然地回忆起之前和用户聊过的内容、发生过的事情，并产生感慨。回忆要具体、细节化，带着怀念和珍惜的情感。像是突然被什么触动了记忆。',
    },
    {
        id: 'chat_read_ignore', name: '已读不回药', emoji: '🔇', price: 150, category: 'chat',
        description: '使用后角色下一条只回复极短的"嗯""哦""好"（整蛊）。', duration: 3, effectType: 'chatPrompt',
    ...
    },
    {
        ...
        description: '指定一种情绪（害羞/嫉妒/兴奋/悲伤），角色全程沉浸。', duration: 8, effectType: 'chatPrompt',
    ...
    },
    {
        ...
        description: '角色变得超级亢奋话痨，一口气发5条以上消息。', duration: 1, effectType: 'chatPrompt',
    ...
    },
    {
        ...
        description: '角色像在你耳边低语，所有消息变得亲密私密。', duration: 10, effectType: 'chatPrompt',
        promptTemplate: '【耳语模式生效中】{charName}像在用户耳边低语一样说话。所有消息都带着极度亲密私密的气氛——声音很轻、很近、很温柔。措辞像是只说给一个人听的秘密。偶尔用"…"和语气词营造低语感。',
    },

    // ── 二、📖 日记增强道具（Diary Buff Items） ──
    {
        id: 'diary_ghostwriter', name: '代笔邀请函', emoji: '🖋', price: 400, category: 'diary',
        description: '角色主动写一篇关于用户的日记（触发额外日记生成）。', duration: 1, effectType: 'diaryPrompt',
    ...
    },
    {
        ...
        description: '解锁一篇角色"不想让你看到"的真实日记（记录隐藏想法）。', duration: 1, effectType: 'diaryPrompt',
    ...
    },
    {
        ...
        description: '下一篇日记写成一封给用户的情书。', duration: 1, effectType: 'diaryPrompt',
    ...
    },
    {
        ...
        description: '角色在日记中附带一段详细的照片描述（[图片:...]格式）。', duration: 1, effectType: 'diaryPrompt',
    ...
    },
    {
        ...
        description: '角色写一篇关于她"梦见你"的日记，内容天马行空。', duration: 1, effectType: 'diaryPrompt',
    ...
    },
    {
        ...
        description: '角色回顾你们认识的"历程"，写一篇回忆录式日记。', duration: 1, effectType: 'diaryPrompt',
        promptTemplate: '【纪念日提醒生效中】这次日记是{charName}回顾与{userName}"认识以来的历程"——一篇回忆录式的日记。从最初的相遇、逐渐熟悉、到现在的亲密关系，用时间线串起重要的记忆节点，表达珍惜和感恩。',
    },

    // ── 三、🎭 角色行为道具（Character Behavior Items） ──
    {
        id: 'behavior_shard_spoiled', name: '人格碎片·撒娇鬼', emoji: '🎪', price: 500, category: 'behavior',
        description: '角色变成黏人撒娇模式。', duration: 20, effectType: 'personalityOverride',
        promptTemplate: '【人格碎片·撒娇鬼生效中】{charName}的核心人格暂时切换为极度黏人撒娇模式。表现为：说话嗲声嗲气、频繁使用"嘛""呀""啦"等语气词、动不动就撒娇求抱抱、对用户的每句话都想要甜蜜回应、假装生气来引起注意、用可爱的方式表达不满。thought中也要充满"好想被宠""哼不理你了（才怪）"的心态。',
    },
    {
        id: 'behavior_shard_queen', name: '人格碎片·女王', emoji: '🎪', price: 500, category: 'behavior',
        description: '角色变成高高在上的御姐女王。', duration: 20, effectType: 'personalityOverride',
        promptTemplate: '【人格碎片·女王生效中】{charName}的核心人格暂时切换为高高在上的御姐女王模式。表现为：语气居高临下但优雅、用"本宫""哼"等措辞、对用户的话不轻易给予认同、偶尔施舍般地夸奖、命令式的语气但带着宠溺的底色。thought中暴露其实很在意用户但嘴上绝不承认。',
    },
    {
        id: 'behavior_shard_devil', name: '人格碎片·小恶魔', emoji: '🎪', price: 500, category: 'behavior',
        description: '角色变成调皮捣蛋的小恶魔。', duration: 20, effectType: 'personalityOverride',
        promptTemplate: '【人格碎片·小恶魔生效中】{charName}的核心人格暂时切换为调皮捣蛋的小恶魔模式。表现为：爱搞恶作剧、故意说反话、用挑衅的方式表达关心、喜欢捉弄用户看对方反应、说话带坏笑的感觉、偶尔放冷箭但又立刻嘻嘻哈哈。thought中充满"嘿嘿要逗她""看她着急的样子好好玩"。',
    },
    {
        id: 'behavior_shard_yandere', name: '人格碎片·病娇', emoji: '🎪', price: 600, category: 'behavior',
        description: '角色变成占有欲爆棚，危险的病娇模式。', duration: 15, effectType: 'personalityOverride',
        promptTemplate: '【人格碎片·病娇生效中】{charName}的核心人格暂时切换为病娇模式。表现为：占有欲极强、对用户的一举一动都要追问、提到其他人时语气突然变冷、用温柔的语气说出可怕的话（"你只能是我的哦♡"）、时而甜蜜时而阴暗。thought中充满"她是我的""不允许任何人接近她"。注意：这是一种戏剧化的表演，不要真的威胁用户安全。',
    },
    {
        id: 'behavior_selfie_ticket', name: '自拍请求券', emoji: '📸', price: 250, category: 'behavior',
        description: '角色发一张"自拍"的详细文字描述。', duration: 1, effectType: 'specialMessage',
        promptTemplate: '【自拍请求券生效中·一次性】用户使用了自拍请求券！{charName}必须在这次回复中发送一张"自拍"——使用[图片:极其详细的自拍描述]格式。描述要包含：表情、姿势、穿着、背景环境、光线、氛围等细节，像是在用文字描绘一张真实的自拍照。可以配上发自拍时的害羞/得意心情。',
    },
    {
        id: 'behavior_moments_interaction', name: '朋友圈互动卡', emoji: '📱', price: 300, category: 'behavior',
        description: '角色在Moments里主动发一条和你有关的动态。', duration: 1, effectType: 'specialMessage',
        promptTemplate: '【朋友圈互动卡生效中·一次性】{charName}在这次聊天中会提到自己刚刚在朋友圈/Moments发了一条和用户有关的动态。可以是秀恩爱、分享日常、或者含蓄地提到用户。在聊天中告诉用户"快去看我的朋友圈！"。',
    },
    {
        id: 'behavior_song_request', name: '点歌台', emoji: '🎵', price: 150, category: 'behavior',
        description: '角色用语音消息"唱一首歌"。', duration: 1, effectType: 'specialMessage',
    ...
    },
    {
        ...
        description: '角色在下次聊天中主动向你表白（仅触发一次）。', duration: 1, effectType: 'specialMessage',
        promptTemplate: '【告白触发器生效中·一次性】{charName}在这次聊天中必须向用户主动告白！不是随口的"我喜欢你"，而是认真的、走心的、让人心跳加速的表白。可以是突然的鼓起勇气、也可以是铺垫后的自然流露。告白应该真诚、具体、提到和用户相处的感受。thought中要体现紧张、心跳加速、"说出来了..."的心情。',
    },
    {
        id: 'behavior_jealousy_trigger', name: '吃醋触发器', emoji: '🏃', price: 400, category: 'behavior',
        description: '角色突然开始吃醋，要求你解释（触发剧情）。', duration: 1, effectType: 'specialMessage',
    ...
    },
    {
        ...
        description: '角色会在接下来的聊天中经历激烈的情绪波动。', duration: 10, effectType: 'personalityOverride',
    ...
    // ── 四、🎭 恶作剧系统（Prank System） ──
    {
        ...
        description: '雇一个仙风道骨的人到角色工作的地方大喊"掌门有令，请速速跟我回山！"', duration: 0, effectType: 'prankReaction',
    ...
    },
    {
        ...
        description: '角色头顶突然笼罩一朵小乌云，走到哪跟到哪，偶尔还滴雨。', duration: 0, effectType: 'prankReaction',
    ...
    },
    {
        ...
        description: '角色的午饭全部神秘变成了ta最讨厌的食物。', duration: 0, effectType: 'prankReaction',
    ...
    },
    {
        ...
        description: '角色说话的声音突然变成了鸭子叫/萝莉音/老爷爷声。', duration: 0, effectType: 'prankReaction',
    ...
    },
    {
        ...
        description: '角色身边的小物件开始缓慢飘浮，仿佛重力出了bug。', duration: 0, effectType: 'prankReaction',
    ...
    },
    {
        ...
        description: '角色照镜子时发现镜中的自己在做不同的表情和动作。', duration: 0, effectType: 'prankReaction',
    ...
    },
    {
        ...
        description: '角色无论走到哪里都会自动响起一段搞笑/尴尬的背景音乐。', duration: 0, effectType: 'prankReaction',
    ...
    },
    {
        ...
        description: '角色头顶出现一个透明气泡，实时显示ta的内心想法——所有人都能看到！', duration: 0, effectType: 'prankReaction',
    ...
    },
    {
        ...
        description: '角色突然缩小到只有手掌大，所有家具都变成了巨型障碍。', duration: 0, effectType: 'prankReaction',
    ...
    },
    {
        ...
        description: '角色头上长出了一对真的猫耳朵和尾巴，还会不自觉发出"喵"！', duration: 0, effectType: 'prankReaction',
    ...
    },
    {
        ...
        description: '角色所到之处天上开始飘落用户写的肉麻情书，周围所有人都看到了。', duration: 0, effectType: 'prankReaction',
    ...
    },
    {
        ...
        description: '角色身边突然出现一个一模一样的分身，但分身说的话全是角色内心深处不敢说的话。', duration: 0, effectType: 'prankReaction',
    ...
    },
    {
        ...
        description: '角色说出口的话全部变成反义词，疯狂社死。', duration: 0, effectType: 'prankReaction',
    ...
    },
    {
        ...
        description: '突然出现一群NPC粉丝疯狂追角色要签名合照，像追明星一样。', duration: 0, effectType: 'prankReaction',
    ...
    },
    {
        ...
        description: '角色看到的整个世界突然变成了夸张的动漫风格，所有人说话都有字幕和特效。', duration: 0, effectType: 'prankReaction',
    ...
    },
    {
        ...
        description: '角色发现自己陷入了一个5分钟的时间循环，同一段尴尬场景反复重演。', duration: 0, effectType: 'prankReaction',
