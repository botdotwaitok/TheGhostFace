        ...
        sections: [
            {
                title: '本次主题：一批小修',
                items: [
                    '<strong>兼容 ChatGPT 模型</strong>——适配 <code>gpt-5.5</code> 之类的模型接口。',
                ],
            },
            {
                title: '合作者「老爱」贡献',
                items: [
                    '<strong>分离酒馆自带世界书编辑器与插件绑定世界书的关系</strong>——两者不再互相牵连。',
                ],
            },
            {
                title: '调整',
                items: [
                    '<strong>总结触发值可自定义</strong>——在「设置 - 聊天」里可以自己调整自动总结的触发阈值。',
                ],
            },
        ],
    },
        ...
        sections: [
            {
                title: '本次主题：一批小优化',
                items: [
                    '<strong>回家总结多了一步「确认页」</strong>——选「压缩总结」回家时，鬼面生成的总结会先在一个全屏页面里，可以直接<em>编辑</em>后再发给线下场景。',
                ],
            },
            {
                title: '修复',
                items: [
                    '<strong>世界书关键词在手机聊天里有时不触发</strong>已修复。',
                ],
            },
            {
                title: '调整',
                items: [
                    '<strong>模型加载失败的提示更详细</strong>：以前只甩一句原始报错，现在会区分是请求超时、跨域(CORS)/网络不通、还是地址写错，给出对应的排查方向。',
                    '<strong>聊天统计页多了「短信总结」一行</strong>。',
                    '总结的「保留最近未压缩消息数」从 30 条收紧到 10 条，让滚动总结触发得更贴近上下文实际增长。',
                    '重写了情感内核提示词。',
                ],
            },
        ],
